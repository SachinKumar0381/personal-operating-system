...
import type { WeeklySummary } from "@/features/reports/types";
...
export function WeeklySummarySection({ data }: WeeklySummaryProps): React.ReactElement {
  const completionPct =
  ...
  return (
    <GlassCard variant="default" padding="lg">
      ...
      <p className="mb-5 text-xs text-muted-foreground">
        Mon → Sun · your activity at a glance
      </p>
